                ...
                <div class="card">
                    <div class="card-header row d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-6 text-right">
                            <a class="btn btn-sm btn-special" href="#" id="abrirModalCreate">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('.reactivo').on('change', function() {
            if ($(this).is(':checked')) {
                $('.container_reactivo').removeClass('hidden');
                $('#circuito').attr('required', true);
                $('#turno').attr('required', true);

            } else {
                $('.container_reactivo').addClass('hidden');
                $('#circuito').removeAttr('required');
        ...
        $('#abrirModalCreate').on('click', function(e) {
            e.preventDefault();

            var modal = new bootstrap.Modal(document.getElementById('ModalCreate'));
            modal.show();

            $('.reactivo').prop('checked', false);
            $('.container_reactivo').addClass('hidden');
            $('#documento_solicitante').val('').removeClass('is-valid is-invalid');
            $('#nombre_solicitante').val('').removeClass('is-valid is-invalid');
            $('#destino').val('');
            $('#circuito').val('');
            $('#turno').val('');
            $('.cart-product').val('').trigger('change');
            $('.product-qty').val('');
            $('#tablaProductos tbody tr:not(:first)').remove();

            let first_row = $('#tablaProductos tbody tr').first();
            first_row.find('input, select').val('');
        });
    </script>
